...
DEMO1_VM2_NET='demo1-net1,demo1-net2'
...
function get_network_id {
    ...
    local NETWORK_ID=$(neutron net-list -F id -F name |  awk -v net=${NETWORK_NAME} '$4 ~ net {print $2}')
    echo $NETWORK_ID
}
